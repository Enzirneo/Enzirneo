<h1 align="center">Enzo Villela Bispo</h1>
...
<p align="center">
  Desenvolvendo aplicações modernas, escaláveis e bem estruturadas, com foco em experiência do usuário,
  arquitetura de software e interfaces que unem estética e funcionalidade.
</p>
...
Sou desenvolvedor com foco em construção de aplicações web modernas, unindo desenvolvimento **full stack**, **arquitetura de software** e **design de interfaces**.

Tenho interesse especial em criar produtos bem organizados, escaláveis e visualmente consistentes, pensando não só no código, mas também na experiência de quem usa.

Atualmente, venho trabalhando em projetos com foco em:
- aplicações web modernas
- componentização e organização de código
- interfaces com atenção a UI/UX
- arquitetura preparada para crescimento e manutenção
- integração entre frontend, backend e regras de negócio
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=html,css,js,ts,react,angular,vue,nodejs,python,java,cpp,go,git,github,vscode" />
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/UI%2FUX-EC4899?style=for-the-badge" />
  <img src="https://img.shields.io/badge/Web%20Development-0F766E?style=for-the-badge" />
